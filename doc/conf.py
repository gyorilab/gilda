...
latex_documents = [
    (master_doc, 'gilda.tex', 'Gilda Documentation',
     'Benjamin M. Gyori', 'manual'),
]
...
man_pages = [
    (master_doc, 'gilda', 'gilda Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gilda', 'gilda Documentation',
     author, 'gilda', 'One line description of project.',
     'Miscellaneous'),
]
